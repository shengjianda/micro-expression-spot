...
path_SAMM="C:/sheng/SAMM/SAMM_longvideos/"
path_label='C:/sheng/SAMM/SAMM_LongVideos_V3_Release.xls'
...
def worker(vio, i_worker):
    ...
    path5 = vio
    # SAMM
    pp = fl.draw_roiline19(path_SAMM, path5, 6, -4, 7)  # 18是直接使用光流计算，19是全部，20是去掉全局移动
    pp = pp * 7
    print("pp")
    print(pp)
    ...
    with open(f'samm_rst{i_worker}.pkl', 'wb') as f:
...
def multivideo_SAMM(path4):
    ...
    for i_worker in range(n_result):
        with open(f'samm_rst{i_worker}.pkl', 'rb') as f:
